...
export default function CareersModel({ opacity = 1, ...props }) {
    ...
    useLayoutEffect(() => {
        ...
        if (glowRef.current && !currentItemUiVisible) {
            tlRef.current
                .fromTo(
                ...
                .fromTo(
                    ...
                    {
                        x: glowRef.current.scale.x,
                        y: glowRef.current.scale.y,
                        z: glowRef.current.scale.z,
                    },
                    {
                        x: "+=0.1",
                        y: "+=0.1",
        ...
        return () => (tlRef.current ? tlRef.current.kill() : null);
    }, [glowRef, currentItemUiVisible]);
